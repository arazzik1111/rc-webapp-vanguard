...
import { FacebookConnectionToken } from '@models/swagger/App/Domain/Presence/Entities/ListingServices/Facebook/Locations/Connection/Token/FacebookConnectionToken';
...
export const FacebookConnectionConnectionState = {
  CONNECTED: 'CONNECTED',
...
export const FacebookConnectionConnectionStateStrict = {
  CONNECTED: 'CONNECTED',
  NOT_CONNECTED: 'NOT_CONNECTED',
  ACCOUNT_CONNECTED: 'ACCOUNT_CONNECTED',
  IN_PROGRESS: 'IN_PROGRESS',
...
export const FacebookConnectionConnectionType = {
...
export const FacebookConnectionConnectionTypeStrict = {
  SERIVCE_API: 'SERIVCE_API',
  TOKEN: 'TOKEN',
  SELF_MANAGED: 'SELF_MANAGED',
  NONE: 'NONE',
...
export const FacebookConnectionProfileState = {
  UNKNOWN: 'UNKNOWN',
...
export const FacebookConnectionProfileStateStrict = {
  UNKNOWN: 'UNKNOWN',
  FULLY_OPERATIONAL: 'FULLY_OPERATIONAL',
  NOT_CREATED: 'NOT_CREATED',
  IN_CREATION: 'IN_CREATION',
...
export const FacebookConnectionSyncState = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
};

export const FacebookConnectionSyncStateStrict = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
} as const;

export const FacebookConnectionObjectType = {
  App_Domain_Presence_Entities_ListingServices_Facebook_Locations_Connection_FacebookConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Facebook\\Locations\\Connection\\FacebookConnection',
};

export const FacebookConnectionObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_Facebook_Locations_Connection_FacebookConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Facebook\\Locations\\Connection\\FacebookConnection',
} as const;

export type FacebookConnection = {
  connectionToken?: FacebookConnectionToken;
  instagramProfile?: InstagramConnectionProfile;
  /**
   * The Facebook token connect flow init URL
   */
  facebookTokenConnectFlowInitUrl?: string;
  /**
   ...
   *
   */
  connectionState?: (typeof FacebookConnectionConnectionState)[keyof typeof FacebookConnectionConnectionState];
  /**
   ...
   *
   */
  connectionType?: (typeof FacebookConnectionConnectionType)[keyof typeof FacebookConnectionConnectionType];
  /**
   ...
   *
   */
  profileState?: (typeof FacebookConnectionProfileState)[keyof typeof FacebookConnectionProfileState];
  /**
   ...
   *
   */
  syncState?: (typeof FacebookConnectionSyncState)[keyof typeof FacebookConnectionSyncState];
  /**
   ...
   */
  objectType: (typeof FacebookConnectionObjectType)[keyof typeof FacebookConnectionObjectType];
};
