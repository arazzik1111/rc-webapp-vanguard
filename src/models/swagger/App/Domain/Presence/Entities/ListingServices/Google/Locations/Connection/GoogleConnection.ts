...
import { GoogleConnectionToken } from '@models/swagger/App/Domain/Presence/Entities/ListingServices/Google/Locations/Connection/Token/GoogleConnectionToken';
...
export const GoogleConnectionConnectionState = {
  CONNECTED: 'CONNECTED',
...
export const GoogleConnectionConnectionStateStrict = {
  CONNECTED: 'CONNECTED',
  NOT_CONNECTED: 'NOT_CONNECTED',
  ACCOUNT_CONNECTED: 'ACCOUNT_CONNECTED',
  IN_PROGRESS: 'IN_PROGRESS',
...
export const GoogleConnectionConnectionType = {
...
export const GoogleConnectionConnectionTypeStrict = {
  SERIVCE_API: 'SERIVCE_API',
  TOKEN: 'TOKEN',
  SELF_MANAGED: 'SELF_MANAGED',
  NONE: 'NONE',
...
export const GoogleConnectionProfileState = {
  UNKNOWN: 'UNKNOWN',
...
export const GoogleConnectionProfileStateStrict = {
  UNKNOWN: 'UNKNOWN',
  FULLY_OPERATIONAL: 'FULLY_OPERATIONAL',
  NOT_CREATED: 'NOT_CREATED',
  IN_CREATION: 'IN_CREATION',
...
export const GoogleConnectionSyncState = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
};

export const GoogleConnectionSyncStateStrict = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
} as const;

export const GoogleConnectionObjectType = {
  App_Domain_Presence_Entities_ListingServices_Google_Locations_Connection_GoogleConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Google\\Locations\\Connection\\GoogleConnection',
};

export const GoogleConnectionObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_Google_Locations_Connection_GoogleConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Google\\Locations\\Connection\\GoogleConnection',
} as const;
...
export type GoogleConnection = {
   ...
   *
   */
  connectionState?: (typeof GoogleConnectionConnectionState)[keyof typeof GoogleConnectionConnectionState];
  /**
   ...
   *
   */
  connectionType?: (typeof GoogleConnectionConnectionType)[keyof typeof GoogleConnectionConnectionType];
  /**
   ...
   *
   */
  profileState?: (typeof GoogleConnectionProfileState)[keyof typeof GoogleConnectionProfileState];
  /**
   ...
   *
   */
  syncState?: (typeof GoogleConnectionSyncState)[keyof typeof GoogleConnectionSyncState];
  /**
   ...
   */
  objectType: (typeof GoogleConnectionObjectType)[keyof typeof GoogleConnectionObjectType];
};
