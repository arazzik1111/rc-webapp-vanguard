...
import { XConnectionToken } from '@models/swagger/App/Domain/Presence/Entities/ListingServices/X/Locations/Connection/Token/XConnectionToken';
...
export const XConnectionConnectionState = {
  CONNECTED: 'CONNECTED',
...
export const XConnectionConnectionStateStrict = {
  CONNECTED: 'CONNECTED',
  NOT_CONNECTED: 'NOT_CONNECTED',
  ACCOUNT_CONNECTED: 'ACCOUNT_CONNECTED',
  IN_PROGRESS: 'IN_PROGRESS',
...
export const XConnectionConnectionType = {
...
export const XConnectionConnectionTypeStrict = {
  SERIVCE_API: 'SERIVCE_API',
  TOKEN: 'TOKEN',
  SELF_MANAGED: 'SELF_MANAGED',
  NONE: 'NONE',
...
export const XConnectionProfileState = {
  UNKNOWN: 'UNKNOWN',
...
export const XConnectionProfileStateStrict = {
  UNKNOWN: 'UNKNOWN',
  FULLY_OPERATIONAL: 'FULLY_OPERATIONAL',
  NOT_CREATED: 'NOT_CREATED',
  IN_CREATION: 'IN_CREATION',
...
export const XConnectionSyncState = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
};

export const XConnectionSyncStateStrict = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
} as const;

export const XConnectionObjectType = {
  App_Domain_Presence_Entities_ListingServices_X_Locations_Connection_XConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\X\\Locations\\Connection\\XConnection',
};

export const XConnectionObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_X_Locations_Connection_XConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\X\\Locations\\Connection\\XConnection',
} as const;

export type XConnection = {
  connectionToken?: XConnectionToken;
  /**
   ...
   */
  xTokenConnectFlowInitUrl?: string;
  /**
   ...
   *
   */
  connectionState?: (typeof XConnectionConnectionState)[keyof typeof XConnectionConnectionState];
  /**
   ...
   *
   */
  connectionType?: (typeof XConnectionConnectionType)[keyof typeof XConnectionConnectionType];
  /**
   ...
   *
   */
  profileState?: (typeof XConnectionProfileState)[keyof typeof XConnectionProfileState];
  /**
   ...
   *
   */
  syncState?: (typeof XConnectionSyncState)[keyof typeof XConnectionSyncState];
  /**
   ...
   */
  objectType: (typeof XConnectionObjectType)[keyof typeof XConnectionObjectType];
};
