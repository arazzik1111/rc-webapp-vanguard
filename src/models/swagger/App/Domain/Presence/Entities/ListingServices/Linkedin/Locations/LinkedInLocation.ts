...
export const LinkedInLocationServiceAreaType = {
...
export const LinkedInLocationServiceAreaTypeStrict = {
  BUSINESS_TYPE_UNSPECIFIED: 'BUSINESS_TYPE_UNSPECIFIED',
  CUSTOMER_LOCATION_ONLY: 'CUSTOMER_LOCATION_ONLY',
  CUSTOMER_AND_BUSINESS_LOCATION: 'CUSTOMER_AND_BUSINESS_LOCATION',
} as const;

export const LinkedInLocationObjectType = {
  App_Domain_Presence_Entities_ListingServices_Linkedin_Locations_LinkedInLocation:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Linkedin\\Locations\\LinkedInLocation',
};

export const LinkedInLocationObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_Linkedin_Locations_LinkedInLocation:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Linkedin\\Locations\\LinkedInLocation',
} as const;
...
export type LinkedInLocation = {
  ...
  pageUrl?: string;
  /**
   * The Linkedin Page Profile Picture URL
   */
   ...
   */
  websiteUrl?: string;
  logoPicture?: LinkedinMediaItem;
  /**
   * Linkedin organization Cover picture url
   */
  ...
  countryCode?: string;
  /**
   * Type of primary organization being used
   */
   ...
   *
   */
  serviceAreaType?: (typeof LinkedInLocationServiceAreaType)[keyof typeof LinkedInLocationServiceAreaType];
  /**
   * Location's radius
   */
  radius?: number;
   ...
   */
  objectType: (typeof LinkedInLocationObjectType)[keyof typeof LinkedInLocationObjectType];
  /**
