...
export const ArgusLocationObjectType = {
  App_Domain_Presence_Entities_ListingServices_Argus_Locations_ArgusLocation:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Argus\\Locations\\ArgusLocation',
};

export const ArgusLocationObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_Argus_Locations_ArgusLocation:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Argus\\Locations\\ArgusLocation',
} as const;
...
export type ArgusLocation = {
   ...
   */
  objectType: (typeof ArgusLocationObjectType)[keyof typeof ArgusLocationObjectType];
  /**
