...
export const XPostType = {
  POST: 'POST',
  EVENT: 'EVENT',
  OFFER: 'OFFER',
};

export const XPostTypeStrict = {
  POST: 'POST',
  EVENT: 'EVENT',
  OFFER: 'OFFER',
} as const;

export const XPostStatus = {
  SCHEDULED: 'SCHEDULED',
  PUBLISHED: 'PUBLISHED',
...
export const XPostStatusStrict = {
  SCHEDULED: 'SCHEDULED',
  PUBLISHED: 'PUBLISHED',
  PUBLISHING: 'PUBLISHING',
  NO_DIRECTORIES_SELECTED_FOR_PUBLISHING: 'NO_DIRECTORIES_SELECTED_FOR_PUBLISHING',
...
export const XPostObjectType = {
  App_Domain_Presence_Entities_ListingServices_X_Locations_Posts_XPost:
    'App\\Domain\\Presence\\Entities\\ListingServices\\X\\Locations\\Posts\\XPost',
};

export const XPostObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_X_Locations_Posts_XPost:
    'App\\Domain\\Presence\\Entities\\ListingServices\\X\\Locations\\Posts\\XPost',
} as const;
...
export type XPost = {
   ...
   *
   */
  type?: (typeof XPostType)[keyof typeof XPostType];
  /**
   * Status of the post
   *  Allowed Values:
   ...
   *
   */
  status?: (typeof XPostStatus)[keyof typeof XPostStatus];
  /**
   ...
   */
  objectType: (typeof XPostObjectType)[keyof typeof XPostObjectType];
  /**
