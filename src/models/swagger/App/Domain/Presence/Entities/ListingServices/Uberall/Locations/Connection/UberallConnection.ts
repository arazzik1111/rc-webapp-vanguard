...
export const UberallConnectionConnectionState = {
  CONNECTED: 'CONNECTED',
...
export const UberallConnectionConnectionStateStrict = {
  CONNECTED: 'CONNECTED',
  NOT_CONNECTED: 'NOT_CONNECTED',
  ACCOUNT_CONNECTED: 'ACCOUNT_CONNECTED',
  IN_PROGRESS: 'IN_PROGRESS',
...
export const UberallConnectionConnectionType = {
...
export const UberallConnectionConnectionTypeStrict = {
  SERIVCE_API: 'SERIVCE_API',
  TOKEN: 'TOKEN',
  SELF_MANAGED: 'SELF_MANAGED',
  NONE: 'NONE',
...
export const UberallConnectionProfileState = {
  UNKNOWN: 'UNKNOWN',
...
export const UberallConnectionProfileStateStrict = {
  UNKNOWN: 'UNKNOWN',
  FULLY_OPERATIONAL: 'FULLY_OPERATIONAL',
  NOT_CREATED: 'NOT_CREATED',
  IN_CREATION: 'IN_CREATION',
...
export const UberallConnectionSyncState = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
};

export const UberallConnectionSyncStateStrict = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
} as const;

export const UberallConnectionObjectType = {
  App_Domain_Presence_Entities_ListingServices_Uberall_Locations_Connection_UberallConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Uberall\\Locations\\Connection\\UberallConnection',
};

export const UberallConnectionObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_Uberall_Locations_Connection_UberallConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Uberall\\Locations\\Connection\\UberallConnection',
} as const;

export type UberallConnection = {
  /**
   ...
   *
   */
  connectionState?: (typeof UberallConnectionConnectionState)[keyof typeof UberallConnectionConnectionState];
  /**
   ...
   *
   */
  connectionType?: (typeof UberallConnectionConnectionType)[keyof typeof UberallConnectionConnectionType];
  /**
   ...
   *
   */
  profileState?: (typeof UberallConnectionProfileState)[keyof typeof UberallConnectionProfileState];
  /**
   ...
   *
   */
  syncState?: (typeof UberallConnectionSyncState)[keyof typeof UberallConnectionSyncState];
  /**
   ...
   */
  objectType: (typeof UberallConnectionObjectType)[keyof typeof UberallConnectionObjectType];
};
