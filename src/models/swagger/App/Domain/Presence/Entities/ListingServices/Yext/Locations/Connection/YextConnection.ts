...
export const YextConnectionConnectionState = {
  CONNECTED: 'CONNECTED',
...
export const YextConnectionConnectionStateStrict = {
  CONNECTED: 'CONNECTED',
  NOT_CONNECTED: 'NOT_CONNECTED',
  ACCOUNT_CONNECTED: 'ACCOUNT_CONNECTED',
  IN_PROGRESS: 'IN_PROGRESS',
...
export const YextConnectionConnectionType = {
...
export const YextConnectionConnectionTypeStrict = {
  SERIVCE_API: 'SERIVCE_API',
  TOKEN: 'TOKEN',
  SELF_MANAGED: 'SELF_MANAGED',
  NONE: 'NONE',
...
export const YextConnectionProfileState = {
  UNKNOWN: 'UNKNOWN',
...
export const YextConnectionProfileStateStrict = {
  UNKNOWN: 'UNKNOWN',
  FULLY_OPERATIONAL: 'FULLY_OPERATIONAL',
  NOT_CREATED: 'NOT_CREATED',
  IN_CREATION: 'IN_CREATION',
...
export const YextConnectionSyncState = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
};

export const YextConnectionSyncStateStrict = {
  IN_SYNC: 'IN_SYNC',
  NEVER_SYNCED: 'NEVER_SYNCED',
  OUT_OF_SYNC: 'OUT_OF_SYNC',
} as const;

export const YextConnectionObjectType = {
  App_Domain_Presence_Entities_ListingServices_Yext_Locations_Connection_YextConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Yext\\Locations\\Connection\\YextConnection',
};

export const YextConnectionObjectTypeStrict = {
  App_Domain_Presence_Entities_ListingServices_Yext_Locations_Connection_YextConnection:
    'App\\Domain\\Presence\\Entities\\ListingServices\\Yext\\Locations\\Connection\\YextConnection',
} as const;

export type YextConnection = {
  /**
   * The date and time when the subscription was started.
   */
  subscriptionStartDate?: string;
  /**
   * The date and time when the subscription ended.
   */
   ...
   *
   */
  connectionState?: (typeof YextConnectionConnectionState)[keyof typeof YextConnectionConnectionState];
  /**
   ...
   *
   */
  connectionType?: (typeof YextConnectionConnectionType)[keyof typeof YextConnectionConnectionType];
  /**
   ...
   *
   */
  profileState?: (typeof YextConnectionProfileState)[keyof typeof YextConnectionProfileState];
  /**
   ...
   *
   */
  syncState?: (typeof YextConnectionSyncState)[keyof typeof YextConnectionSyncState];
  /**
   ...
   */
  objectType: (typeof YextConnectionObjectType)[keyof typeof YextConnectionObjectType];
};
