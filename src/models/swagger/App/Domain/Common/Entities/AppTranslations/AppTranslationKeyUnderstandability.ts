export const AppTranslationKeyUnderstandabilityObjectType = {
  App_Domain_Common_Entities_AppTranslations_AppTranslationKeyUnderstandability:
    'App\\Domain\\Common\\Entities\\AppTranslations\\AppTranslationKeyUnderstandability',
};

export const AppTranslationKeyUnderstandabilityObjectTypeStrict = {
  App_Domain_Common_Entities_AppTranslations_AppTranslationKeyUnderstandability:
    'App\\Domain\\Common\\Entities\\AppTranslations\\AppTranslationKeyUnderstandability',
} as const;
