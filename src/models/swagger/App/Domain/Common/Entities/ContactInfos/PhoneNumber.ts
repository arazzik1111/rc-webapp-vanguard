...
export const PhoneNumberTypeStrict = {
  PHONE: 'PHONE',
} as const;
...
export const PhoneNumberScopeStrict = {
  PHONE: 'PHONE',
  MOBILEPHONE: 'MOBILEPHONE',
  ADDITIONALPHONE: 'ADDITIONALPHONE',
  FAX: 'FAX',
...
export const PhoneNumberValidationLevelStrict = {
  VALIDATION_EXACT: 'VALIDATION_EXACT',
  VALIDATION_POSSIBLE: 'VALIDATION_POSSIBLE',
} as const;
...
export const PhoneNumberObjectTypeStrict = {
  App_Domain_Common_Entities_ContactInfos_PhoneNumber: 'App\\Domain\\Common\\Entities\\ContactInfos\\PhoneNumber',
} as const;
