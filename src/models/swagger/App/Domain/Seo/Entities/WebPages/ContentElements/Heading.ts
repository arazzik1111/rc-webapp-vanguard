...
export const HeadingHeadingTypeStrict = {
  H1: 'H1',
  H2: 'H2',
  H3: 'H3',
  H4: 'H4',
...
export const HeadingObjectType = {
  App_Domain_Seo_Entities_WebPages_ContentElements_Heading:
    'App\\Domain\\Seo\\Entities\\WebPages\\ContentElements\\Heading',
};

export const HeadingObjectTypeStrict = {
  App_Domain_Seo_Entities_WebPages_ContentElements_Heading:
    'App\\Domain\\Seo\\Entities\\WebPages\\ContentElements\\Heading',
} as const;
