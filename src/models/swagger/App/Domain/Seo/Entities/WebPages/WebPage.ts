import { ArgusGraphLocations } from '@models/swagger/App/Domain/Presence/Entities/ListingServices/Argus/Locations/ArgusGraphLocations';
...
export const WebPageObjectTypeStrict = {
  App_Domain_Seo_Entities_WebPages_WebPage: 'App\\Domain\\Seo\\Entities\\WebPages\\WebPage',
} as const;
...
export type WebPage = {
  ...
  potentialArgusLocations?: ArgusGraphLocations;
  /**
