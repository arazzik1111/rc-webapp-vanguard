...
export const MetaDescriptionObjectType = {
  App_Domain_Seo_Entities_WebPages_ContentElements_MetaDescription:
    'App\\Domain\\Seo\\Entities\\WebPages\\ContentElements\\MetaDescription',
};

export const MetaDescriptionObjectTypeStrict = {
  App_Domain_Seo_Entities_WebPages_ContentElements_MetaDescription:
    'App\\Domain\\Seo\\Entities\\WebPages\\ContentElements\\MetaDescription',
} as const;
