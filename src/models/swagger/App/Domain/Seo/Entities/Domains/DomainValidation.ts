...
export const DomainValidationValidationModeStrict = {
  full: 'full',
  host: 'host',
} as const;
...
export const DomainValidationObjectTypeStrict = {
  App_Domain_Seo_Entities_Domains_DomainValidation: 'App\\Domain\\Seo\\Entities\\Domains\\DomainValidation',
} as const;
...
export type DomainValidation = {
   ...
   *  Allowed Values:
   * -   `full`: Mode of validation - Full
   * -   `host`: Mode of validation - Host
   *
   */
