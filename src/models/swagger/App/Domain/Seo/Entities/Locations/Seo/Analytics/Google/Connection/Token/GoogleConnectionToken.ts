import { GoogleAccountProfile } from '@models/swagger/App/Domain/Seo/Entities/Locations/Seo/Analytics/Google/Connection/Token/GoogleAccountProfile';
...
export const GoogleConnectionTokenObjectType = {
  App_Domain_Seo_Entities_Locations_Seo_Analytics_Google_Connection_Token_GoogleConnectionToken:
    'App\\Domain\\Seo\\Entities\\Locations\\Seo\\Analytics\\Google\\Connection\\Token\\GoogleConnectionToken',
};
...
export type GoogleConnectionToken = {
  ...
  connectedProperties?: GoogleAnalyticsProperties;
  /**
   * Whether this token is in active use or not
   */
  isActive?: boolean;
  /**
