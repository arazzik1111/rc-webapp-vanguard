...
export enum PUB_SUB_EVENTS {
  ...
  reactActionBarRemoveMessage = 'REACT_ACTION_BAR_REMOVE',
  reactActionBarSetFooter = 'REACT_ACTION_BAR_SET_FOOTER',
  reactActionBarHideFooter = 'REACT_ACTION_BAR_HIDE_FOOTER',
  reactDrawerOpen = 'REACT_DRAWER_OPEN',
  reactDrawerClose = 'REACT_DRAWER_CLOSE',
}
