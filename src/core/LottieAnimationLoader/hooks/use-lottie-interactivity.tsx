import { LottieRefCurrentProps } from '@vanguard/LottieAnimationLoader/hooks/use-lottie';
...
export const useInitInteractivity = ({ wrapperRef, animationItem, mode, actions }: InitInteractivity) => {
  useEffect(() => {
...
export const useLottieInteractivity = ({ actions, mode, lottieObj }: InteractivityProps): ReactElement => {
