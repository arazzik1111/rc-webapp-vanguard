...
export type LottieOptions = Omit<AnimationConfigWithData, 'container' | 'animationData'> & {
...
export const useLottie = (
   ...
   * @param forceFlag
   */
  const playSegments = (segments: AnimationSegment | AnimationSegment[], forceFlag?: boolean): void => {
  ...
  const loadAnimation = (forcedConfigs = {}) => {
    ...
    // Clone animationData to avoid "object is not extensible" error
    const clonedAnimationData = animationData ? JSON.parse(JSON.stringify(animationData)) : animationData;
