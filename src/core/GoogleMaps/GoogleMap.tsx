import {
  ...
  unregisterEvents,
} from '@vanguard/GoogleMaps/GoogleMapsMarker/map-helper';
import React, { type CSSProperties, memo, PureComponent, type ReactNode, useEffect, useRef, useState } from 'react';
...
function GoogleMapFunctional({
  ...
  onLoad,
  onUnmount,
}: GoogleMapProps): React.JSX.Element {
  ...
  return (
    <div id={id} ref={ref} style={mapContainerStyle} className={mapContainerClassName}>
